...
<body>
	...
	<h2>【表單 文字+圖片上傳】</h2>
	<form action="/receive_form_image" method="POST"
	...
	<script>
		// 【選取元素】
		const memberNameInput = document.querySelector("input[name=employeeName]")
		const memberAgeInput = document.querySelector("input[name=employeeAge]")
